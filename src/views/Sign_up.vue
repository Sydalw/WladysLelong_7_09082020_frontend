        ...
        <div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                <div class="md:flex w-full">
                    <div class="hidden md:flex flex-col bg-blue-900 w-1/2">
                      <div class="my-auto">
                        <svg data-v-1084b650="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300"><!----> <!----> <rect data-v-1084b650="" fill="none" x="0" y="0" width="200px" height="200px" class="logo-background-square"></rect> <!----> 
                            ...
                            <g data-v-1084b650="" id="4cb061db-73fa-16fe-1d0a-15980590225e" stroke="none" fill="#FFD7D7" transform="matrix(0.2931737713407769,0,0,0.2931737713407769,106.0239289062273,82.12728504171139)">
    ...
    signin: function() {
      if (store.state.champsInscription.pwd1===store.state.champsInscription.pwd2) {
        ...
        .post('http://localhost:3000/api/signup', {
          name: store.state.champsInscription.name, 
          surname: store.state.champsInscription.surname,
          username: store.state.champsInscription.pseudo,
          email: store.state.champsInscription.email,
          password: store.state.champsInscription.pwd1
          })
        .then(reponse => {
        ...
        alert('Le mot de passe confirmé est différent du mot de passe choisi');
      }
    }
  }
}
