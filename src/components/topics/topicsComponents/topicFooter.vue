<template>
    <div class="flex justify-start items-center my-1 -ml-2" :id="topicId">
        ...
        <div class="flex" >
            <div v-on:click="toggleNewComment()" class="flex cursor-pointer hover:bg-gray-200 px-2 py-2 rounded-sm">
            ...
            <div v-if="topicType === 'post'" class="cursor-pointer flex hover:bg-gray-200 px-2 ml-2 py-2 rounded-sm">
            ...
            <div v-on:click="toggleEdit()" v-if="displayEdit" class="cursor-pointer flex hover:bg-gray-200 px-2 ml-2 py-2 rounded-sm">
                ...
                <span class="ml-2 sm:block hidden text-xs font-semibold text-gray-500">Éditer</span>
            </div>
            ...
            <div v-on:click="deleteTopic()" v-if="displayDelete" class="cursor-pointer flex hover:bg-gray-200 px-2 ml-2 py-2 rounded-sm">
