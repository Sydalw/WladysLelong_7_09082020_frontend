<template>
    <div class="w-full max-w-4xl pt-2 border border-gray-200 rounded-xl pl-3 mt-8 bg-white" :id="id">
        ...
        <div class="flex justify-between sm:justify-start items-center my-1 -ml-2">
            <div class="flex">
                ...
                <div class="flex px-2">
                    ...
                    <span class="ml-2 text-xs font-semibold text-red-500">{{dislikes}}</span>
                </div>
            </div>
            <div class="flex">
                <div class="flex cursor-pointer hover:bg-gray-200 px-2 py-2 rounded-sm">
